      ...
      <img v-if="showLimboMessage2nd" 
           ...
           <img v-if="showProceedPrompt" 
            ...
            <img v-if = "showYouWin" src="@/assets/buttons/proceedNext.png" alt="Start" style="position: fixed; top: 450px; left: 600px; width: 250px; height: auto;" />
             ...
             <div v-if="second_prompt">
            <img src="@/assets/prompts/second-prompt.gif" alt="Start" style="position: fixed; top: -1px; left: -1px; width: 1500px; height: 750px;" />
            </div>
    </div>
  </main>
</template>
...
import limboSpike from '@/assets/obstacle/limboSpike.gif';
...
checkCollision() {
      ...
      if (this.lineX === 870 && this.lineY === 500 && this.showLimboSpike == false) {
        ...
        setTimeout(() => {
          this.show50HP = false; 
          if(!this.xKeyPressed && this.showLimboAttack == true){
    ...
    nextLevel() {
      this.second_prompt = true;
    
      setTimeout(() => {
        this.second_prompt = false;
