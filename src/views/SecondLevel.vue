    ...
    <div class="container">
      ...
      <img v-if = "showLust" 
          :src="lust" 
           alt="lust" 
           class="character"
           style="position: fixed; top: 420px; left: 1000px; width: 320px; height: auto;">

      <img v-if ="showLustAttack"
           :src="lustAttack" 
           alt="lust" 
           class="character"
           style="position: fixed; top: 420px; left: 1000px; width: 320px; height: auto;">
      ...
      <img v-if="showLimboMessage" 
             ...
             alt="Death GIF" 
             class="character"
             style="position: fixed; top: 320px; left: 1090px; width: 250px; height: auto;">
      ...
      <img v-if="showLimboMessage2nd" 
           ...
           <img v-if="showProceedPrompt" 
            ...
            <img src="@/assets/prompts/third-prompt.gif" alt="Start" style="position: fixed; top: -1px; left: -1px; width: 1500px; height: 750px;" />
            </div>
    </div>
  </main>
</template>
...
import limbo_line_first from '@/assets/convo/cleo-dante/cleo-line-first.png';
import dante_line_first from '@/assets/convo/cleo-dante/dante-line-first.png';
import dante_line_second from '@/assets/convo/cleo-dante/dante-line-second.png';
import limbo_line_second from '@/assets/convo/cleo-dante/cleo-line-second.png';
...
checkCollision() {
      ...
      if (this.lineX === 870 && this.lineY === 520 && this.showLimboSpike == false) {
        ...
        setTimeout(() => {
          this.show50HP = false; 
          if(!this.xKeyPressed && this.showLustAttack == true){
...
<style scoped>
main {
  background-image: url('@/assets/background/3rd-bg.gif');
