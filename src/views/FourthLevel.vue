<template>
    <main>
      <div class="container">
        ...
        <img v-if="showDeathGif" 
             ...
             alt="Death GIF" 
             class="character"
             style="position: fixed; top: 510px; left: 320px; width: 250px; height: auto;">
        ...
        <img v-if="showLimboSpike" 
             ...
             :src="limboSpike2" 
             alt="limboSpike2" 
             style="position: fixed; top: 420px; left: 400px; width: 100px; height: auto;">
        ...
        <img v-if ="showLimboDeath"
           ...
           alt="limbo" 
           class="character"
           style="position: fixed; top: 580px; left: 400px; width: 100px; height: auto;">
        ...
        <img v-if="showLimboMessage2nd" 
             ...
             <img v-if="showProceedPrompt" 
              ...
              <img v-if = "showYouWin" src="@/assets/buttons/proceedNext.png" alt="Start" style="position: fixed; top: 510px; left: 600px; width: 250px; height: auto;" />
               ...
               <div v-if="fifth_prompt">
            <img src="@/assets/prompts/fifth_prompt.gif" alt="Start" style="position: fixed; top: -1px; left: -1px; width: 1500px; height: 750px;" />
            </div>
  ...
  import limboSpike from '@/assets/obstacle/greedSpike.gif';
  import limboSpike2 from '@/assets/obstacle/greedSpike.gif';
  ...
  import limbo_line_first from '@/assets/convo/plut-dante/plut-line-first.png';
  import dante_line_first from '@/assets/convo/plut-dante/dante-line-first.png';
  import dante_line_second from '@/assets/convo/plut-dante/dante-line-second.png';
  import limbo_line_second from '@/assets/convo/plut-dante/plut-line-second.png';
  ...
  handleKeyDown(event) {
    ...
    switch (event.key) {
      ...
      case 'x':
        ...
        if ((this.lineX === 180 && this.lineY === 500) || 
            (this.lineX === 190 && this.lineY === 500) || 
            (this.lineX === 200 && this.lineY === 500) || 
            (this.lineX === 170 && this.lineY === 500)) {
  ...
  checkCollision() {
        ...
        if (this.lineX === 250 && this.lineY === 500 && this.showLimboSpike2 === true) {
          this.isDead = true; 
      ...
      nextLevel() {
        this.fifth_prompt = true;
    
    setTimeout(() => {
      this.fifth_prompt = false;
