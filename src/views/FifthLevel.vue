  ...
  <main>
    <div class="container">
      ...
      <img v-if="showDeathGif" 
           ...
           alt="Death GIF" 
           class="character"
           style="position: fixed; top: 180px; left: 220px; width: 250px; height: auto;">

           <img v-if="showDeathGif2" 
             :src="deathGif" 
             alt="Death GIF" 
             class="character"
             style="position: fixed; top: 180px; left: 320px; width: 250px; height: auto;">

      <img v-if="showIdleGif" 
           :src="idleGif" 
           class="character"
           style="position: fixed; top: 180px; left: 570px; width: 250px; height: auto;">
      ...
      <img v-if = "showAnger" 
          :src="anger" 
           alt="anger" 
           class="character"
           style="position: fixed; top: 5px; left: 1000px; width: 400px; height: auto;">

      <img v-if ="showAngerAttack"
           :src="angerAttack" 
           alt="anger" 
           class="character"
           style="position: fixed; top: 5px; left: 1000px; width: 400px; height: auto;">
      ...
      <img v-if ="showLimboDeath"
           ...
           alt="limbo" 
           class="character"
           style="position: fixed; top: 250px; left: 300px; width: 100px; height: auto;">

           <img v-if ="showLimboDeath3"
           :src="limboDeath" 
           alt="limbo" 
           class="character"
           style="position: fixed; top: 250px; left: 400px; width: 100px; height: auto;">
     
      <img v-if="showDanteMessage" 
             :src="dante_line_first" 
             alt="Death GIF" 
             class="character"
             style="position: fixed; top: 40px; left: 490px; width: 250px; height: auto;">

      <img v-if="showLimboMessage" 
             :src="limbo_line_first" 
             alt="Death GIF" 
             class="character"
             style="position: fixed; top: 1px; left: 1090px; width: 250px; height: auto;">
...
import anger from '@/assets/boss/anger.gif';
import angerAttack from '@/assets/boss/angerAttack.gif';
import limboDeath from '@/assets/boss/limboDeath.gif';
import limboSpike from '@/assets/obstacle/angerSpike.gif';
...
import limbo_line_first from '@/assets/convo/anger-dante/anger-line-first.png';
import dante_line_first from '@/assets/convo/anger-dante/dante-line-first.png';
import dante_line_second from '@/assets/convo/anger-dante/dante-line-second.png';
import limbo_line_second from '@/assets/convo/anger-dante/anger-line-second.png';
...
export default {
  ...
  if (this.lineX === 880 && this.lineY === 180 && this.showLimboSpike == false) {
    ((direction === 'left' && this.lineX - this.step >= 880) || 
        (direction === 'right' && this.lineX + this.step <= 890)) 
  } else {
    switch (direction) {
      case 'up':
        this.lineY = Math.max(this.lineY - this.step, 180);
        break;
      case 'down':
        this.lineY = Math.min(this.lineY + this.step, 180);
        break;
      case 'left':
...
handleKeyDown(event) {
  ...
  switch (event.key) {
    ...
    case 'x':
      ...
      if ( (this.lineX === 880 && this.lineY === 180 && !this.limboDeathTimeout)) {
        this.limboDeathTimeout = true; 
        setTimeout(() => {
          this.showAngerAttack = false; 
      ...
      if ((this.lineX === 80 && this.lineY === 180) || 
          (this.lineX === 90 && this.lineY === 180) || 
          (this.lineX === 100 && this.lineY === 180) || 
          (this.lineX === 70 && this.lineY === 180)) {
        setTimeout(() => {
      ...
      if ((this.lineX === 180 && this.lineY === 180) || 
            (this.lineX === 190 && this.lineY === 180) || 
            (this.lineX === 200 && this.lineY === 180) || 
            (this.lineX === 170 && this.lineY === 180)) {
          setTimeout(() => {
...
checkCollision() {
      if (this.lineX === 120 && this.lineY === 180 && this.showLimboSpike == true) {
        this.isDead = true; 
      ...
      if (this.lineX === 250 && this.lineY === 180 && this.showLimboSpike2 === true) {
          this.isDead = true; 
      ...
      if (this.lineX === 520 && this.lineY === 180 && this.showLimboSpike == false) {
        this.isDead = true;
      ...
      if (this.lineX === 870 && this.lineY === 180 && this.showLimboSpike == false) {
        this.showAngerAttack = true;
        ...
        setTimeout(() => {
          this.show50HP = false; 
          if(!this.xKeyPressed && this.showAngerAttack == true){
    ...
    nextLevel() {
      this.sixth_prompt = true;
    
    setTimeout(() => {
      this.sixth_prompt = false;
      this.$router.push('/sixth-level');
    }, 5000); 
  },
}
};
...
<style scoped>
main {
  background-image: url('@/assets/background/6th-bg.gif');
