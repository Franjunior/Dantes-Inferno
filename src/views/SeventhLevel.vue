<template>
      ...
      <div class="container">
        ...
        <img v-if = "showViolence" 
            :src="violence" 
             alt="violence" 
             class="character"
             style="position: fixed; top: 370px; left: 1000px; width: 400px; height: auto;">
  
        <img v-if ="showViolenceAttack"
             :src="violenceAttack" 
             alt="violence" 
             class="character"
             style="position: fixed; top: 370px; left: 1000px; width: 400px; height: auto;">
        ...
        <img v-if="showLimboMessage2nd" 
             ...
             <img v-if="showProceedPrompt" 
              ...
              <img v-if = "showYouWin" src="@/assets/buttons/proceedNext.png" alt="Start" style="position: fixed; top: 510px; left: 600px; width: 250px; height: auto;" />
               ...
               <div v-if="eigth_prompt">
            <img src="@/assets/prompts/eigth-prompt.gif" alt="Start" style="position: fixed; top: -1px; left: -1px; width: 1400px; height: 800px;" />
            </div>
  ...
  import violence from '@/assets/boss/violence.gif';
  ...
  checkCollision() {
        ...
        if (this.lineX === 870 && this.lineY === 520 && this.showLimboSpike == false) {
          this.showViolenceAttack = true;
          this.showViolence = false;
          ...
          setTimeout(() => {
            this.show50HP = false; 
            if(!this.xKeyPressed && this.showViolenceAttack == true){
          ...
          if(this.showViolenceAttack === false) {
              this.showLimboDeath = true;
          };
  ...
  <style scoped>
  main {
    background-image: url('@/assets/background/8th-bg.gif');
