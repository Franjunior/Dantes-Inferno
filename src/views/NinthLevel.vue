<template>
  ...
  handleKeyDown(event) {
    ...
    switch (event.key) {
      ...
      case 'x':
        ...
        if ((this.lineX === 80 && this.lineY === 550) || 
            (this.lineX === 90 && this.lineY === 550) || 
            (this.lineX === 100 && this.lineY === 550) || 
  ...
  checkCollision() {
        if (this.lineX === 120 && this.lineY === 550 && this.showLimboSpike == true) {
          this.isDead = true; 
        ...
        if (this.lineX === 870 && this.lineY === 550 && this.showLimboSpike == false) {
          ...
          setTimeout(() => {
            this.show50HP = false; 
            if(!this.xKeyPressed && this.showTreacheryAttack == true){
          ...
          if(this.showTreacheryAttack === false) {
              this.showLimboDeath = true;
          };
  ...
  <style scoped>
  main {
    background-image: url('@/assets/background/10th-bg.gif');
