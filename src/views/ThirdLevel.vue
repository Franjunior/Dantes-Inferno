  ...
  <main>
    <div class="container">
      ...
      <img v-if="showLimboSpike" 
           :src="limboSpike" 
           alt="limboSpike" 
           style="position: fixed; top: 625px; left: 300px; width: 100px; height: auto;">
      
      <img v-if = "showGluttony" 
          :src="gluttony" 
           alt="gluttony" 
           class="character"
           style="position: fixed; top: 270px; left: 1000px; width: 500px; height: auto;">

      <img v-if ="showGluttonyAttack"
           :src="gluttonyAttack" 
           alt="gluttony" 
           class="character"
           style="position: fixed; top: 270px; left: 1000px; width: 500px; height: auto;">
      ...
      <img v-if="showLimboMessage" 
             ...
             alt="Death GIF" 
             class="character"
             style="position: fixed; top: 240px; left: 1090px; width: 250px; height: auto;">
      ...
      <img v-if="showLimboMessage2nd" 
           ...
           <img v-if="showProceedPrompt" 
            ...
            <img v-if = "showYouWin" src="@/assets/buttons/proceedNext.png" alt="Start" style="position: fixed; top: 510px; left: 600px; width: 250px; height: auto;" />
             ...
             <div v-if="fourth_prompt">
            <img src="@/assets/prompts/fourth-prompt.gif" alt="Start" style="position: fixed; top: -1px; left: -1px; width: 1500px; height: 750px;" />
            </div>
...
import gluttony from '@/assets/boss/gluttony.gif';
import gluttonyAttack from '@/assets/boss/gluttonyAttack.gif';
import limboDeath from '@/assets/boss/limboDeath.gif';
import limboSpike from '@/assets/obstacle/gluttonySpike.gif';
...
import limbo_line_first from '@/assets/convo/glut-dante/glut-line-first.png';
import dante_line_first from '@/assets/convo/glut-dante/dante-line-first.png';
import dante_line_second from '@/assets/convo/glut-dante/dante-line-second.png';
import limbo_line_second from '@/assets/convo/glut-dante/glut-line-second.png';
...
checkCollision() {
      if (this.lineX === 120 && this.lineY === 520 && this.showLimboSpike == true) {
        this.isDead = true; 
      ...
      if (this.lineX === 520 && this.lineY === 520 && this.showLimboSpike == false) {
        this.isDead = true;
      ...
      if (this.lineX === 870 && this.lineY === 520 && this.showLimboSpike == false) {
        this.showGluttonyAttack = true;
        this.showGluttony = false;
        ...
        setTimeout(() => {
          this.show50HP = false; 
          if(!this.xKeyPressed && this.showGluttonyAttack == true){
        ...
        if(this.showGluttonyAttack === false) {
            this.showLimboDeath = true;
        };
    ...
    nextLevel() {
      this.fourth_prompt = true;
    
    setTimeout(() => {
      this.fourth_prompt = false;
      this.$router.push('/fourth-level');
    }, 5000); 
  },
}
};
...
<style scoped>
main {
  background-image: url('@/assets/background/4th-bg.gif');
